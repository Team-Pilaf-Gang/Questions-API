/* Run the following commands in order to build database into correct format with seeded data */

/* Run each copy statement individually */
...
/* Alter table individually to allow for correct data output*/
